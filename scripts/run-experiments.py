...
faulty_runs = []
faulty_runs.append("-ir '{\"1\": \"50\"}'")
faulty_runs.append("-ir '{\"1\": \"100\", \"2\": \"250\"}'")
faulty_runs.append("-ib 50")
runs = 5
...
if __name__ == '__main__':
    ...
    for i in range(1, 4):
        for j in range(1, runs+1):
            ...
            subprocess.run(f"python3 scripts/run-test.py -c 15 -o 40 -b {int((threads * 40 * 0.75) / 2)} -d {duration} "
